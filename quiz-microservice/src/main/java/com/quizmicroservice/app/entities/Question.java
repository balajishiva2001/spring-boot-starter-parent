...
public class Question {
	...
	public Question(int questionId, String category, String difficultyLevel, String questionTitle, String option1,
	...
	public String toString() {
		return "Question [questionId=" + questionId + ", category=" + category + ", difficultyLevel=" + difficultyLevel
